...
;
;
;	LZMA decompressor algorithm
;	LZMA Standar written by Brandon LaCombe
;	LZMA Special written by anvie the part engine of ANSAV 
;
;
;

; LZMA Standard 
; written by Brandon LaCombe
...
_lzma_depack proc; ------- LZMA Standard ------- ;
	 push ebp
	 mov ebp,esp
	 sub esp,30h
	 xor eax,eax
